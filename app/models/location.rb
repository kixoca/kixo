class Location < ActiveRecord::Base
  ...
  has_one :region,      :class_name => 'Where', :foreign_key => 'locality_id'
  has_one :postal_code, :class_name => 'Where', :foreign_key => 'locality_id'
  has_one :country,     :class_name => 'Where', :foreign_key => 'locality_id'
